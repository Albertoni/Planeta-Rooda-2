...
$projeto_id = is_numeric($_GET['projeto_id']) ? $_GET['projeto_id'] : die("A id do projeto s&oacute; pode conter n&uacute;meros. Id passada: ".$_GET['projeto_id']);
...
<?
		...
		$tituloProjeto = $consulta->resultado['titulo'];
