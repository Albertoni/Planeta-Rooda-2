...
/*
* Classe que implementa o terreno gelo, com 4 pontes.
*/
class c_terreno_gelo extends c_terreno_colisao_complexa {
//dados
	public var POS_X_INICIO_AREA_UTIL:Number = 705;
	public var POS_Y_INICIO_AREA_UTIL:Number = 100;
	private var COMPRIMENTO_ESTIMADO:Number = 1700;
...
//métodos
	public function inicializar(dados_personagem_param:c_personagem_bd, imagem_bd_param:c_terreno_bd){
		...
		*/
		...
		/*adicionarObjetoAcesso(this['acesso_noroeste_novo'], c_objeto_acesso.LINK_MUDANCA_TERRENO.concat(_root.terreno_status.oeste));
		adicionarObjetoAcesso(this['acesso_sudoeste_novo'], c_objeto_acesso.LINK_MUDANCA_TERRENO.concat(_root.terreno_status.oeste));
		adicionarObjetoAcesso(this['acesso_nordeste_novo'], c_objeto_acesso.LINK_MUDANCA_TERRENO.concat(_root.terreno_status.leste));
		adicionarObjetoAcesso(this['acesso_sudeste_novo'], c_objeto_acesso.LINK_MUDANCA_TERRENO.concat(_root.terreno_status.leste));*/
