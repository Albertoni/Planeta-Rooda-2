...
class fatoresMotivacionaisPerguntas extends FuncionalidadeFatorMotivacional{
//dados
...
//mйtodos
	...
	*/
	protected function retornaConexaoAcessosFuncionalidade($usuario, $dataInicio, $dataFim, $divisaoTempo){ 
		$bibliotecaTurma = new PerguntasTurma($this->idTurma);
	...
	*/
	...
	/***********************************************************
	*	Fatores dentro de vбrias unidades de tempo
	*************************************************************/
	protected function produzMP(){ return FuncionalidadeFatorMotivacional::VARIAVEL_INDEFINIDA_PARA_FUNCIONALIDADE; }
	protected function produzTO(){ return FuncionalidadeFatorMotivacional::VARIAVEL_INDEFINIDA_PARA_FUNCIONALIDADE; }
}
?>