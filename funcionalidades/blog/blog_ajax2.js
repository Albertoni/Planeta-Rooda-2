...
var linkHTML = function (id,url) {
    return "<li class=\"tabela_blog\" id=\"liLink"+id+"\"><a href=\""+url+"\" target=\"_blank\" align=\"left\">"+url+"</a><button type=\"button\" class=\"bt_excluir\" onclick=\"ROODA.ui.confirm('Tem certeza que deseja apagar este link?',function(){deleteLink("+id+");});\" ></button></li>";
}
/* ADD LINK AJAX */
