...
***************************** -->
      ...
      <div id="criar_topico" class="bloco">
        ...
        <ul class="sem_estilo">
                ...
                <li class="tabela">
                 <br />
                 <b>Pergunta :</b>
                <li><input type="text" style="height:40px" value="Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Etiam eget ligula eu lectus lobortis condimentum. Aliquam nonummy auctor massa. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas"/>
                </li>
               ...
               <br />
                ...
                <b>Opção 1:</b>
                <div id="opcção" style="margin-top:10px"><input type="text" value="Lorem ipsum dolor sit amet, consectetuer adipiscing elit."/>
    ...
    <a href="planeta_pergunta_editar_professor.html"><input type="image" src="../../images/botoes/bt_voltar.png" align="left" style="margin-top:20px"/></a>
    <a href=""><input type="image" src="../../images/botoes/bt_confirm.png" align="right" style="margin-top:20px"/></a>
